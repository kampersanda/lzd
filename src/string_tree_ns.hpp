...
class Node {
 public:
  ...
  Node(unsigned int in_edge_begin, unsigned int in_edge_len, unsigned int depth, unsigned int id,
       unsigned int fid);
  ~Node(){};
...
class Tree {
 ...
 public:
  ...
  inline size_t getStrSize() const {
   ...
   * @return
   */
  unsigned int findLastNodeIdFrom(const Node* node, unsigned long long strbegin, bool findFNode,
                                  unsigned int len = UINT_MAX) const;
  inline Node* findLastNodeFrom(const Node* node, unsigned int strbegin, bool findFNode,
                                unsigned int len = UINT_MAX) const {
